...
export class XamlToMarkdownConverter {
    ...
    processParagraph(paragraph, skipNewline = false) {
    ...
    extractElementContent(element) {
        ...
        if (Array.isArray(element)) { // Added explicit array handling
            ...
            for (const item of element) {
                content += this.extractElementContent(item);
            }
            return content;
        }
        let content = '';
